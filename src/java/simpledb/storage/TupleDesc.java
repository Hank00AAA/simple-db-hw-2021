...
public class TupleDesc implements Serializable {
    ...
    public TupleDesc(Type[] typeAr) {
        String[] defaultFieldAr = new String[typeAr.length];
        init(typeAr, defaultFieldAr);
    }
    ...
    public static TupleDesc merge(TupleDesc td1, TupleDesc td2) {
        ...
        for (Iterator<TDItem> it = td1.iterator(); it.hasNext(); ) {
            TDItem item = it.next();
        ...
        for (Iterator<TDItem> it = td2.iterator(); it.hasNext(); ) {
            TDItem item = it.next();
            typeAr[index] = item.fieldType;
            fieldAr[index] = item.fieldName;
            ++index;
